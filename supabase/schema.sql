...
INSERT INTO public.properties (host_id, destination_id, name, description, property_type, max_guests, price_per_night, images) VALUES
(
  (SELECT id FROM auth.users LIMIT 1),
  (SELECT id FROM public.destinations WHERE name = 'Serengeti National Park' LIMIT 1),
  'Luxury Safari Lodge',
  'Experience the Serengeti in comfort with our luxury safari lodge featuring panoramic views and premium amenities.',
  'lodge',
  4,
  450.00,
  ARRAY['https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=800', 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800']
),
(
  (SELECT id FROM auth.users LIMIT 1),
  (SELECT id FROM public.destinations WHERE name = 'Cape Town' LIMIT 1),
  'Oceanview Apartment',
  'Modern apartment with stunning ocean views in the heart of Cape Town.',
  'apartment',
  2,
  120.00,
  ARRAY['https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=800', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=800']
);
